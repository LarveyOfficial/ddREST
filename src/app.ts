...
export function createApp(cfg: Config): OpenAPIHono<AppEnv> {
  ...
  for (const path of ['/v1/restaurants', '/v1/nearby-stores', '/v1/stores/*', '/v1/carts', '/v1/carts/*', '/v1/orders', '/v1/orders/*', '/v1/addresses', '/v1/addresses/*', '/v1/payment-methods', '/v1/product-lists']) {
